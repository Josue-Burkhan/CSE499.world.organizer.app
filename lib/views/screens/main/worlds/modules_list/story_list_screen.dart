...
final storyListStreamProvider = StreamProvider.family
    .autoDispose<List<StoryEntity>, String>((ref, worldLocalId) {
      return ref
          .watch(storyRepositoryProvider)
          .watchStoriesInWorld(worldLocalId);
    });

final storySyncProvider = FutureProvider.autoDispose
    .family<void, ({String worldLocalId, String? worldServerId})>((
      ...
      if (ids.worldServerId != null) {
        ...
        await syncService.syncDirtyStories();
        await syncService.fetchAndMergeStories(
          ids.worldLocalId,
          ids.worldServerId!,
        );
      }
...
class StoryListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final asyncStories = ref.watch(storyListStreamProvider(worldLocalId));

    return Scaffold(
      appBar: AppBar(
        title: Text('Stories in $worldName'),
        actions: [
          IconButton(
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildStoryCard(context, ref, story);
                },
              ),
            );
          }
            ...
            error: (e, st) {
              return Center(
                child: Padding(
                  ...
                  child: Text('Failed to load stories: $e'),
                ),
              );
            },
          );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Create your first story to weave narratives in your world!',
  ...
  Widget _buildStoryCard(
    ...
    final color = _getTagColor(story.tagColor);
      ...
      child: Dismissible(
        ...
        confirmDismiss: (direction) async {
          if (direction == DismissDirection.startToEnd) {
            return await _showDeleteConfirmation(context, story.name);
          ...
          if (direction == DismissDirection.startToEnd) {
            try {
              ref
                  ...
                  .deleteStory(story.localId);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('"${story.name}" was deleted.')),
              );
            } catch (e) {
        ...
        child: ListTile(
          ...
          onTap: () {
            if (story.serverId != null) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('This story has not been synced yet.'),
