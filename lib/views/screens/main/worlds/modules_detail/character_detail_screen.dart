        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              ...
              _buildRawList('Locations', character.rawLocations),
              _buildRawList('Creatures', character.rawCreatures),
              _buildRawList('Power Systems', character.rawPowerSystems),
              _buildRawList('Religions', character.rawReligions),
              _buildRawList('Economies', character.rawEconomies),
              _buildRawList('Stories', character.rawStories),
              _buildRawList('Technologies', character.rawTechnologies),
              _buildRawList('Languages', character.rawLanguages),
            ]),
          ),
        ],
      ),
