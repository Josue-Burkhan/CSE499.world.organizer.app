...
class ItemSyncService {
  ...
  Map<String, dynamic> _createBodyFromEntity(ItemEntity item, String worldServerId) {
    return {
      ...
      'rawCreatedBy': item.rawCreatedBy.map((e) => e.name).toList(),
      'rawUsedBy': item.rawUsedBy.map((e) => e.name).toList(),
      'rawCurrentOwnerCharacter': item.rawCurrentOwnerCharacter.map((e) => e.name).toList(),
      'rawFactions': item.rawFactions.map((e) => e.name).toList(),
      'rawEvents': item.rawEvents.map((e) => e.name).toList(),
      'rawStories': item.rawStories.map((e) => e.name).toList(),
      'rawLocations': item.rawLocations.map((e) => e.name).toList(),
      'rawReligions': item.rawReligions.map((e) => e.name).toList(),
      'rawTechnologies': item.rawTechnologies.map((e) => e.name).toList(),
      'rawPowerSystems': item.rawPowerSystems.map((e) => e.name).toList(),
      'rawLanguages': item.rawLanguages.map((e) => e.name).toList(),
      'rawAbilities': item.rawAbilities.map((e) => e.name).toList(),
    };
  }
}